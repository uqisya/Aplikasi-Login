...
loginFormElement.addEventListener('submit', function(event) {
    ...
    /* Comment: validasi nilai email dan password harus sama dengan nilai yang tersimpan */
    if(email == expectedEmail && password == expectedPassword){
      /* Comment: jika sesuai, maka arahkan ke halaman home */
      goToHome();
    }
    else{
      /* Comment: jika tidak sesuai, berikan pop up message kesalahan pada input */
      showPopUp();
    }
});
